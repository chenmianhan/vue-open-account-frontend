...
evaluateTest = [{
    ...
    options: [{
        ...
        {
            oid: 4,
            option: 'D. 出租、出售房地产等非金融性资产收入'
        },
        {
            oid: 5,
            option: 'E. 无固定收入，或者个人或家庭人均收入低于当地城乡居民最低生活保障标准'
        }
    ],
    type: '财务状况',
    is_radio: false
    ...
    options: [{        oid: 1,
        option:'A. 现在或此前曾从事金融、经济或财会等与金融产品投资相关的工作超过两年'},
        {            oid: 2,
            option:'B. 已取得金融、经济或财会等与金融产品投资相关专业学士以上学位'},
        {            oid: 3,
            option:'C. 取得证券从业资格、期货从业资格、注册会计师证书（CPA）或注册金融分析师证书（CFA）中的一项及以上'},
        {            oid: 4,
            option:'D. 我不符合以上任何一项描述'
        }
    ], 
    type: "投资知识", 
    is_radio: true 
